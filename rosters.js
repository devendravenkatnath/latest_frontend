...
function PhonepeRosters() {
  ...
  function resetActiveEmployee() {
    setActiveEmployee({ status: 'active', name: '', email: '', department: '', fromdate: '', todate: ''});
  }
          ...
          <div className='jumbotron pt-4 m-5'>
            ...
            <div className='d-flex mb-2 align-items-center'>
              ...
              <input
                ...
                value={activeEmployee.fromdate}
                onChange={(evnt) => setActiveEmployee({ ...activeEmployee, fromdate: evnt.target.value })}
              />
            </div>
            ...
            <div className='d-flex mb-2 align-items-center'>
              ...
              <input
                ...
                value={activeEmployee.todate}
                onChange={(evnt) => setActiveEmployee({ ...activeEmployee, todate: evnt.target.value })}
              />
            </div>
            <div className='d-flex mb-2 align-items-center'>
